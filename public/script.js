...
document.getElementById('orderForm').addEventListener('submit', async function(e) {
  ...
  try {
      const response = await fetch('https://four-future-nephew.glitch.me/sendTelegramMessage', {
          method: 'POST',
          headers: {
      ...
      alert('Не вдалося відправити замовлення. Перевірте мережеві налаштування і спробуйте ще раз.');
  }
});
